...
class Cart(models.Model):
    ...
    cust = models.ForeignKey("CustAcc", models.DO_NOTHING)
...
class CustAcc(models.Model):
    ...
    cust_type = models.ForeignKey("CustType", models.DO_NOTHING)
    pos_reg = models.ForeignKey("CustPosReg", models.DO_NOTHING, blank=True, null=True)
...
class CustPosDeclar(models.Model):
    ...
    pos_reg = models.ForeignKey("CustPosReg", models.DO_NOTHING)
    pos_declar_ques = models.ForeignKey("CustPosDeclarQues", models.DO_NOTHING)
...
class CustPosReg(models.Model):
    ...
    accepted_by = models.ForeignKey(Admin, models.DO_NOTHING, db_column="accepted_by")
    postal = models.ForeignKey("Postcode", models.DO_NOTHING)
...
class ImageLine(models.Model):
    ...
    img = models.ForeignKey(Image, models.DO_NOTHING)
    item = models.ForeignKey("Item", models.DO_NOTHING)
...
class Package(models.Model):
    pack = models.OneToOneField(Item, models.DO_NOTHING, primary_key=True)
...
class PackageItem(models.Model):
    ...
    pack = models.ForeignKey(Package, models.DO_NOTHING)
...
class Pickup(models.Model):
    pickup = models.OneToOneField(OrderShipment, models.DO_NOTHING, primary_key=True)
    pickup_dt = models.DateTimeField()
    pickup_loc = models.ForeignKey("PickupLoc", models.DO_NOTHING)
...
class Product(models.Model):
    product = models.OneToOneField(Item, models.DO_NOTHING, primary_key=True)
...
class Review(models.Model):
    ...
    cust = models.ForeignKey(CustAcc, models.DO_NOTHING, blank=True, null=True)
...
class Shipment(models.Model):
    ship = models.OneToOneField(OrderShipment, models.DO_NOTHING, primary_key=True)
    created_tms = models.DateTimeField()
    track_num = models.CharField(max_length=50)
    address = models.ForeignKey("ShippingAddress", models.DO_NOTHING)
    ship_fee = models.ForeignKey("ShippingFee", models.DO_NOTHING)
